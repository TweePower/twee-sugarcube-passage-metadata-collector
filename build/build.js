...
if (process.argv[2] === 'prod') {
    var labraryPath = path.resolve(processDir + '/../dist/passage-metadata-library.min.js');
    var distPath = path.resolve(processDir + '/../dist/passage-metadata.min.js');
} else {
    var labraryPath = path.resolve(processDir + '/../dist/passage-metadata-library.js');
    var distPath = path.resolve(processDir + '/../dist/passage-metadata.js');
}
...
var result = pattern.replace(/\/\*<<PassageMetadataAppLibraryPlaceholder>>\*\//gm, libraryContent);
